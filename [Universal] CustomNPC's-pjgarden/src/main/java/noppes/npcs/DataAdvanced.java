...
public class DataAdvanced {
    ...
    public void setRole(int i) {
        ...
        else if (role == EnumRoleType.SaleShop && !(npc.roleInterface instanceof RoleSaleShop))
        	npc.roleInterface = new RoleSaleShop(npc);
        else if (role == EnumRoleType.PurchaseShop && !(npc.roleInterface instanceof RolePurchaseShop))
        	npc.roleInterface = new RolePurchaseShop(npc);
    }
