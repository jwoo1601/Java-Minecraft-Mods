...
public class MainCommand implements ICommand {
	...
	public static EntityPlayerMP getEntityByUserName(String username) {
		Iterator<EntityPlayerMP> i = MinecraftServer.getServer().getConfigurationManager().playerEntityList.iterator();
