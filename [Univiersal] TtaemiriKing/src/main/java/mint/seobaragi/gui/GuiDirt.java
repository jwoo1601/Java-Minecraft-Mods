...
//		위에꺼가 검은색 안
		...
		RenderNumber.drawNumber(stat.waterLevel < 0? 0 : stat.waterLevel, (int) (x + 15.7f), (int) (y - 23.5f - 5), 0.8f);
		GL11.glColor4f(0.7F, 0.0F, 1.0F, 0.7F);
		RenderNumber.drawNumber(stat.dirtLevel < 0? 0 : stat.dirtLevel, (int) (x + 24.2f), (int) (y + 23.5f + 49), 0.8f);
