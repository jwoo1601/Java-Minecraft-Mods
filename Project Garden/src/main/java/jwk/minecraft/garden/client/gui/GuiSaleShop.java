...
public class GuiSaleShop extends GuiShop {
	...
	protected static final ResourceLocation RES_SPEECH_BUBBLE = new ResourceLocation(ModInfo.ID, "textures/gui/speech_bubble.png");
	protected static final TextureInfo TEX_SPEECH_BUBBLE = new TextureInfo(RES_SPEECH_BUBBLE, 256, 128);
	protected static final RenderableObject OBJ_SPEECH_BUBBLE = new RenderableObject(TEX_SPEECH_BUBBLE, 256, 128);
	
	public GuiSaleShop() { super(OBJ_NPC, OBJ_SALESHOP, OBJ_SPEECH_BUBBLE); }
